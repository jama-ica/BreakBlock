...
namespace MessagePack.Resolvers
{
    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        static GeneratedResolverGetFormatterHelper()
        {
            ...
            {
                { typeof(global::UnityEngine.KeyCode[]), 0 },
                { typeof(global::Gender), 1 },
                { typeof(global::Person), 2 },
                { typeof(global::RLTPS.Model.KeyConfigData), 3 },
            };
        }
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                case 0: return new global::MessagePack.Formatters.ArrayFormatter<global::UnityEngine.KeyCode>();
                case 1: return new MessagePack.Formatters.GenderFormatter();
                case 2: return new MessagePack.Formatters.PersonFormatter();
                case 3: return new MessagePack.Formatters.RLTPS.Model.KeyConfigDataFormatter();
                default: return null;
            }
        }
    }
...
namespace MessagePack.Formatters
{
    ...
    {
        public void Serialize(ref MessagePackWriter writer, global::Gender value, global::MessagePack.MessagePackSerializerOptions options)
        {
            writer.Write((Int32)value);
        }

        public global::Gender Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            return (global::Gender)reader.ReadInt32();
        }
    }
}
...
namespace MessagePack.Formatters
{
    ...
    public sealed class PersonFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Person>
    {
        ...
        public void Serialize(ref MessagePackWriter writer, global::Person value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            formatterResolver.GetFormatterWithVerify<global::Gender>().Serialize(ref writer, value.Gender, options);
            writer.WriteRaw(this.____stringByteKeys[3]);
            formatterResolver.GetFormatterWithVerify<string>().Serialize(ref writer, value.Name, options);
        }

        public global::Person Deserialize(ref MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        __Gender__ = formatterResolver.GetFormatterWithVerify<global::Gender>().Deserialize(ref reader, options);
                        break;
                    case 3:
